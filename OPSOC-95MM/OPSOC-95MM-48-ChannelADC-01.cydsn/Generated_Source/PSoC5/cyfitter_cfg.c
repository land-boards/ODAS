...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000168u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000188u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_FASTCLK_PLL_P), 0x050Cu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT2_AG, 0x88u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT5_AG, 0x01u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT6_AG, 0x45u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR1_SW0, 0x05u);
...
void cyfitter_cfg(void)
{
	...
	ClockSetup();
	/* Set Flash Cycles based on newly configured 32.00MHz Bus Clock. */
