// ======================================================================
// ODAS-PSOC5-01.v generated from TopDesign.cysch
// 12/10/2016 at 10:17
...
module top ;
    ...
    begin : demux_2
        ...
        always @(Net_459 or QO)
        begin
            case (QO[3:0])
                4'b0000:
                begin
                    tmp__demux_2_0_reg = Net_459;
                ...
                begin
                    ...
                    tmp__demux_2_13_reg = 1'b0;
                    tmp__demux_2_14_reg = 1'b0;
                    tmp__demux_2_15_reg = Net_459;
                end
            endcase
        end
        assign Net_415 = tmp__demux_2_0_reg;
        assign Net_416 = tmp__demux_2_1_reg;
        assign Net_417 = tmp__demux_2_2_reg;
        assign Net_418 = tmp__demux_2_3_reg;
        assign Net_419 = tmp__demux_2_4_reg;
        assign Net_420 = tmp__demux_2_5_reg;
        assign Net_421 = tmp__demux_2_6_reg;
        assign Net_422 = tmp__demux_2_7_reg;
        assign Net_423 = tmp__demux_2_8_reg;
        assign Net_424 = tmp__demux_2_9_reg;
        assign Net_425 = tmp__demux_2_10_reg;
        assign Net_122 = tmp__demux_2_11_reg;
        assign Net_123 = tmp__demux_2_12_reg;
        assign Net_71 = tmp__demux_2_13_reg;
        assign Net_72 = tmp__demux_2_14_reg;
        assign Net_73 = tmp__demux_2_15_reg;
    end
    // -- De Mux end --
    ...
    assign Net_575 = Net_502 | Net_640;
    ...
    assign Net_742 = (Net_139[7:0] == Net_160[7:0]);
    ...
    // -- SRFF Start --
    reg  cy_srff_1;
    always @(posedge Net_185)
    begin
        cy_srff_1 <= (Net_183 | Net_189) & ~Net_738;
    end
    ...
    assign Net_502 = (Net_139[7:0] == Net_192[7:0]);
    ...
    assign Net_746 = (Net_139[7:0] == Net_233[7:0]);
    ...
    assign Net_244 = ~Net_189;


    assign Net_245 = ~Net_619;
    ...
    assign Net_738 = Net_640 | Net_742;


    assign Net_748 = Net_640 | Net_746;
