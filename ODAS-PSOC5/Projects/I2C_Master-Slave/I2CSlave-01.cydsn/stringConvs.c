...
int8 findInString(char * stringToParse, char valToFind)
{
    ...
    int8 offset = 0;
    //printLine("looking for");
    //printLine(stringToParse);
...
{
    //printLine("charToNibble: got here");
...
uint32 stringToLong(char * numString)
{
    ...
    //printLine("stringToLong: got here");
    //printLine(numString);
...
void longToString(uint32 lValue, char * resultString)
{
    ...
    //printLine("longToString: got here");
...
void byteToString(uint8 bValue, char * resultString)
{
    ...
    uint32 nibbleVal;
    uint8 resultOffset=0;
    //printLine("byteToString: got here");
