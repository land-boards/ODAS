...
module top ;
    ...
    UART_v2_50_0 UART_1 (
        ...
        .reset(Net_1039),
        .rx(Net_1017),
        .tx_interrupt(Net_1029),
        .rx_interrupt(Net_1030),
        .tx_data(Net_1031),
        .tx_clk(Net_1032),
        .rx_data(Net_1033),
        .rx_clk(Net_1034));
