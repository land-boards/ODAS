// ======================================================================
// ODAS-PSOC5-I2CIO8-Serial-02.v generated from TopDesign.cysch
// 05/10/2017 at 12:38
...
module top ;
    ...
    begin : demux_2
        ...
        assign Net_1114 = tmp__demux_2_0_reg;
        assign Net_1115 = tmp__demux_2_1_reg;
        assign Net_1116 = tmp__demux_2_2_reg;
        assign Net_1117 = tmp__demux_2_3_reg;
        assign Net_1118 = tmp__demux_2_4_reg;
        assign Net_1119 = tmp__demux_2_5_reg;
        assign Net_1120 = tmp__demux_2_6_reg;
    ...
    assign Net_1044 = 1'h0;

    assign Net_1043 = 1'h0;

    assign Net_1042 = 1'h0;
	...
	cy_psoc3_pins_v1_10
		#(.id("744a1d65-b5c1-44a0-8a4a-5d81d7be7cbe"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a445950b-1369-4b4f-9685-00cad8cad4cd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_1 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_1105),
        .tx_interrupt(Net_1106),
        .rx_interrupt(Net_1107),
        .tx_data(Net_1108),
        .tx_clk(Net_1109),
        .rx_data(Net_1110),
        .rx_clk(Net_1111));
    ...
    assign Net_1045 = 1'h0;

    assign Net_1046 = 1'h0;

    assign Net_1047 = 1'h0;

    assign Net_1048 = 1'h0;
